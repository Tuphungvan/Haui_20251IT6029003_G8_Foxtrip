...
router.get(
    ...
    isAuthenticated,
    ensureActive,
    profileController.history
);
router.get(
    "/history/:historyId",
    isAuthenticated,
    ensureActive,
    profileController.historyDetail
);
...
router.get(
    ...
    isAuthenticated,
    ensureActive,
    profileController.rechargeWallet
);
router.post(
    "/recharge-wallet",
    isAuthenticated,
    ensureActive,
    profileController.handleRechargeWallet
);
