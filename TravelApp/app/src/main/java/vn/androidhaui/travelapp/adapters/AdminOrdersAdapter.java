...
import vn.androidhaui.travelapp.databinding.ItemOrderAdminBinding;
...
public class AdminOrdersAdapter extends RecyclerView.Adapter<AdminOrdersAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        if (first != null && first.getImage() != null && !first.getImage().isEmpty()) {
            ...
            holder.binding.ivThumb.setImageResource(vn.androidhaui.travelapp.R.drawable.ic_image_placeholder);
        }
        ...
        switch (type) {
            ...
            case "to_confirm":
                ...
                break;
            case "completed":
                holder.binding.btnAction.setText("Hoàn tất tour");
                holder.binding.btnAction.setOnClickListener(v -> {
